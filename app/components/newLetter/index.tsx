        ...
        <section>
            <div className="container mx-auto lg:max-w-screen-xl md:max-w-screen-md px-4">
                <div className="grid grid-cols-1 gap-y-10 gap-x-6 md:grid-cols-12 xl:gap-x-8">
                    <div className="relative col-span-12 bg-gradient-to-r from-sky-900 via-cyan-600 to-sky-500 rounded-[30px] transform  bg-contain bg-no-repeat">
                        <div className=" z-10 mb-10 mt-24 lg:mx-64 lg:my-24">
                            ...
                            <div>
                                <div className="relative bg-gray text-white focus-within:text-white flex flex-row-reverse rounded-full pt-5 lg:pt-0">
                                    ...
                                    <div className="absolute inset-y-0 right-0 flex items-center pr-6 pt-5 lg:pt-0">
                                        <button type="submit" className="p-3 lg:p-5 focus:outline-none focus:shadow-outline bg-ultramarine hover:bg-midnightblue duration-150 ease-in-out rounded-full">
                                            <SendHorizonal className="text-accent text-2xl lg:text-4xl inline-block" />
